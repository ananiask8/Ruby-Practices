...
describe Board do
  ...
  describe '#in_check?' do
    ...
    it 'correctly checks for a board that IS in check' do
      b2 = Board.new(false)
      b2[[4, 1]] = Rook.new(:black, b2, [4, 1])
      b2[[4, 0]] = Rook.new(:black, b2, [4, 0])
      b2[[6, 4]] = King.new(:black, b2, [6, 4])
      b2[[1, 0]] = King.new(:white, b2, [1, 0])
  ...
  it 'detects draws' do
    b2 = Board.new(false)
    b2[[4, 1]] = King.new(:black, b2, [4, 1])
    b2[[4, 0]] = King.new(:white, b2, [4, 0])
    expect(b2.draw?).to be(true)
  end
